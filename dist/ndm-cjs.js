...
var require_getAbsolutePath = __commonJS({
  "node_modules/watch-ysy/lib/utils/getAbsolutePath.js"(exports, module2) {
    var { resolve: resolve2, isAbsolute: isAbsolute2, extname } = require("path");
    ...
    module2.exports = getAbsolutePath;
  }
});

// node_modules/watch-ysy/lib/utils/exists.js
var require_exists = __commonJS({
  "node_modules/watch-ysy/lib/utils/exists.js"(exports, module2) {
    var fs4 = require("fs");
...
var require_getHash = __commonJS({
  "node_modules/watch-ysy/lib/utils/getHash.js"(exports, module2) {
    ...
    module2.exports = getHash2;
  }
});

// node_modules/watch-ysy/lib/utils/readFile.js
var require_readFile = __commonJS({
  "node_modules/watch-ysy/lib/utils/readFile.js"(exports, module2) {
    var fs4 = require("fs");
...
var require_checkType = __commonJS({
  "node_modules/watch-ysy/lib/utils/checkType.js"(exports, module2) {
...
var require_utils = __commonJS({
  "node_modules/watch-ysy/lib/utils/index.js"(exports, module2) {
...
var require_extensions = __commonJS({
  "node_modules/watch-ysy/lib/extensions.js"(exports, module2) {
    module2.exports = [
      ".js",
      ".vue",
      ".html",
...
var require_FileDetail = __commonJS({
  "node_modules/watch-ysy/lib/FileDetail.js"(exports, module2) {
    var fs4 = require("fs");
    var { relative, dirname, extname } = require("path");
    ...
    module2.exports = FileDetail2;
  }
});

// node_modules/watch-ysy/lib/valid.js
var require_valid = __commonJS({
  "node_modules/watch-ysy/lib/valid.js"(exports, module2) {
...
var require_types = __commonJS({
  "node_modules/watch-ysy/lib/types.js"(exports, module2) {
    module2.exports = {
...
var require_watchExist = __commonJS({
  "node_modules/watch-ysy/lib/watchExist.js"(exports, module2) {
    var { getAbsolutePath } = require_utils();
    var { REDUCED: REDUCED2 } = require_types();
    var { stat, existsSync } = require("fs");
    ...
    module2.exports = watchExist;
  }
});

// node_modules/watch-ysy/lib/watchFileSync.js
var require_watchFileSync = __commonJS({
  "node_modules/watch-ysy/lib/watchFileSync.js"(exports, module2) {
    var { statSync, readFileSync } = require("fs");
    ...
    module2.exports = watchFileSync;
  }
});

// node_modules/watch-ysy/lib/watchFile.js
var require_watchFile = __commonJS({
  "node_modules/watch-ysy/lib/watchFile.js"(exports, module2) {
    var { stat } = require("fs");
    ...
    module2.exports = watchFile;
  }
});

// node_modules/watch-ysy/lib/WatchData.js
var require_WatchData = __commonJS({
  "node_modules/watch-ysy/lib/WatchData.js"(exports, module2) {
    ...
    module2.exports = { WatchFileData, WatchDirData };
  }
});

// node_modules/watch-ysy/lib/utils/findCreateAndRemoveFilePath.js
var require_findCreateAndRemoveFilePath = __commonJS({
  "node_modules/watch-ysy/lib/utils/findCreateAndRemoveFilePath.js"(exports, module2) {
    ...
    module2.exports = findCreateAndRemoveFilePath;
  }
});

// node_modules/watch-ysy/lib/cancelMonitor.js
var require_cancelMonitor = __commonJS({
  "node_modules/watch-ysy/lib/cancelMonitor.js"(exports, module2) {
    var { REDUCED: REDUCED2 } = require_types();
    ...
    module2.exports = cancelMonitor;
  }
});

// node_modules/watch-ysy/lib/watchDir.js
var require_watchDir = __commonJS({
  "node_modules/watch-ysy/lib/watchDir.js"(exports, module2) {
    var { readdir, statSync, stat } = require("fs");
    ...
    module2.exports = watchDir;
  }
});

// node_modules/watch-ysy/lib/watchDirSync.js
var require_watchDirSync = __commonJS({
  "node_modules/watch-ysy/lib/watchDirSync.js"(exports, module2) {
    ...
    module2.exports = watchDirSync;
  }
});

// node_modules/watch-ysy/lib/watch.js
var require_watch = __commonJS({
  "node_modules/watch-ysy/lib/watch.js"(exports, module2) {
    ...
    module2.exports = watch2;
  }
});

// node_modules/watch-ysy/lib/watchSync.js
var require_watchSync = __commonJS({
  "node_modules/watch-ysy/lib/watchSync.js"(exports, module2) {
    var { isArray, isString, isObject, getAbsolutePath } = require_utils();
    ...
    module2.exports = watchSync;
  }
});

// node_modules/watch-ysy/lib/index.js
var require_lib = __commonJS({
  "node_modules/watch-ysy/lib/index.js"(exports, module2) {
...
function normalize(p) {
  return import_path.default.posix.normalize(p).replace(/\\/g, "/");
}
function readPkg(root) {
  return __async(this, null, function* () {
    try {
      const pkgPath = import_path.default.resolve(root, "package.json");
      const result = yield import_fs.default.promises.readFile(pkgPath, "utf-8");
...
function getHash(source) {
  return import_crypto.default.createHash("sha256").update(source).digest("hex");
}
...
function fileExist(filePath, extensions = []) {
  ...
  if (ext !== "") {
    ...
    for (const e of exts) {
      if (import_fs.default.existsSync(filePath + e)) {
        return filePath + e;
      }
    }
    return false;
    ...
    setup(build2) {
      build2.onResolve(
        ...
        ({ path: importee, importer }) => {
          const watchPath = import_path2.default.resolve(import_path2.default.dirname(importer), importee);
...
function startExecute(rootPath, options) {
  return __async(this, null, function* () {
    ...
    options.filename = import_path3.default.basename(options.rootPath);
    const [isExistPkg, type] = yield readPkg(root);
    if (isExistPkg) {
      options.type = type;
    }
    const outfile = normalize(
      import_fs2.default.existsSync(import_path3.default.resolve(root, "node_modules")) ? import_path3.default.resolve(root, `node_modules/.ndmon/${options.filename}`) : import_path3.default.resolve(root, `.ndmon/${options.filename}`)
    );
    const outDir = normalize(import_path3.default.dirname(outfile));
...
function createBundleDir(outDir) {
  return __async(this, null, function* () {
    if (!import_fs2.default.existsSync(outDir)) {
      yield import_fs2.default.promises.mkdir(outDir);
    }
  });
}
    ...
    const res = yield handleAsyncErrorWithRun(function() {
      return __async(this, null, function* () {
        ...
        if (context.hashMap[outfile] !== hash) {
          ...
          yield import_fs2.default.promises.writeFile(outfile, source);
          return true;
        }
        return false;
      });
...
function bundle(options) {
  return __async(this, null, function* () {
    ...
    try {
      buildResult = yield (0, import_esbuild.build)({
...
function nodeBundleFile(options) {
  const stream = (0, import_child_process.spawn)(`node`, [normalize(options.outfile)], {
    cwd: process.cwd()
  });
...
program2.argument(`<path>`).action((path4) => __async(void 0, null, function* () {
  ...
  let rootPath;
  if ((0, import_path4.isAbsolute)(path4)) {
    rootPath = path4;
    if (!import_fs3.default.existsSync(path4)) {
      error(`\u672A\u8BFB\u53D6\u5230\u5165\u53E3\u6587\u4EF6${path4}`);
      return;
    }
  } else {
    rootPath = (0, import_path4.resolve)(root, path4);
